...
NOTE
----
The summary provides the main technical context of the discussion. The clues highlight important terms (e.g., subsystems, APIs, configs, errors) that help identify the responsible component.
...
AMBIGUITY CHECK
---------------
Before finalizing the answer, compare the best component with the second-best component. Select the best component only if it has stronger evidence based on responsibility, source files, or code headers. If the difference between the best and second-best component is unclear, return "NONE".
