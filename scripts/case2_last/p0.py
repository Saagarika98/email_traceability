...
OUTPUT_FILE = os.path.join(BASE_DIR, "results", "case2", "p0_last_result.json")
...
Use SIG labels as an initial ownership/domain signal. If a SIG label clearly matches the email topic, first focus on components under that SIG. 
